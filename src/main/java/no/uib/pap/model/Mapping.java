...
public class Mapping {
    private ImmutableMap<String, String> proteins = ImmutableMap.of();  // Protein accession and name pairs
    ...
    public ImmutableMap<String, String> getProteins() {
        return proteins;
    }
    ...
    public void loadMapsForGeneNetwork() {
        ...
        loadMapsForProteinNetwork(); // proteins, proteinsToComplexes, complexesToProteins, proteinsToSets, setsToProteins
    }
    ...
    public void loadMapsForProteinNetwork() {
        ...
        proteins = (ImmutableMap<String, String>) getSerializedObject("proteins.gz");
